...
public class TileEntityItemPipeRenderer extends TileEntitySpecialRenderer<TileEntityItemPipe> {
	...
	*/
	...
	private boolean shouldRenderLip(TileEntityItemPipeBase pipe, Direction facing) {
	...
	private boolean shouldRenderPipe(TileEntityItemPipeBase pipe, Direction facing) {
		EnumPipeConnection connection = pipe.getInternalConnection(facing);
