...
public class TileEntityCrystalCell extends TileEntity implements ITileEntityBase, ITickableTileEntity, IMultiblockMachine, ISoundController, IExtraCapabilityInformation {
